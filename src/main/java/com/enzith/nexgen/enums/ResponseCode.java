...
public enum ResponseCode {
    ...
    TRAINER_PACKAGE_FIND_SUCCESS(400, "Trainer package is fetched successfully"),
    MEMBER_TRAINING_SESSION_FIND_SUCCESS(400, "Member training session is fetched successfully"),
    ...
    TRAINER_PACKAGE_CREATED_SUCCESS(400, "Trainer package is created successfully"),
    MEMBER_TRAINING_SESSION_CREATED_SUCCESS(400, "Member training session is created successfully"),
    ...
    MEMBER_TRAINING_SESSION_UPDATED_SUCCESS(400, "Member training session is updated successfully"),
    TRAINER_UPDATED_SUCCESS(400, "Trainer is updated successfully"),
    TRAINER_PACKAGE_UPDATED_SUCCESS(400, "Trainer package is updated successfully"),
