...
public class TrainerServiceImpl implements TrainerService {
    ...
    public String updateTrainer(TrainerRequest trainerRequest) {
        Trainer existingTrainer = trainerRepository.findById(trainerRequest.getTrainerId())
    ...
    public TrainerResponse findTrainerById(Long trainerId) {
        return modelMapper.map(trainerRepository.findById(trainerId), TrainerResponse.class);
    }
    ...
    public Map<String, Object> findAllTrainers(String firstName, String phoneNo1, Integer currentPage, Integer pageSize) {
        ...
        Page<Trainer> trainers = trainerRepository.findAll(new TrainerSpecification(criteria), pageable);
    ...
    private void validatePhoneNo1(String phoneNo1) {
        trainerRepository.findByPhoneNo1(phoneNo1)
                .ifPresent(trainer -> {
